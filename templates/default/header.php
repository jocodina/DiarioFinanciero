...
<html lang="es"> <!--<![endif]-->
    ...
    <head>
        ...
        <!--[if (lte IE 8)]>
            ...
            <script type="text/javascript" src="http://diariofinanciero.ida.cl/templates/default/js/selectivizr.js"></script>
        <![endif]-->
            ...
            <div class="main-header">
                ...
                <div class="logo-info row container">
                    <div class="logo-wrapp column7">
                        ...
                        <h1><a href='/' title='Vovler al Inicio' rel='index'><img src="http://diariofinanciero.ida.cl/templates/default/images/logos/logo.svg" data-png="http://diariofinanciero.ida.cl/templates/default/images/logos/logo.png" alt="Diario Financiero" /></a></h1>
